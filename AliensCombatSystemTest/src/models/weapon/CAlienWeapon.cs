...
namespace AliensCombatSystemTest.src.models.weapon
{
    ...
    {
        int m_iVectorsOnAtack, m_iDmgOnAtack, m_iStrikesOnAtack;
        ...
        public override string[] TableFormat
        {
            get
            {
                ...
                tableFormat[4] = m_dbAutoDmgOnAtack.ToString();
                tableFormat[5] = m_dbTimeOnStrike.ToString();
                tableFormat[6] = m_dbHumanResist.ToString();
                tableFormat[7] = m_dbSynthResist.ToString();
                tableFormat[8] = m_dbDmgOnArmorMod.ToString();
                tableFormat[9] = m_dbNockdownHealthThreshold.ToString();
                return tableFormat;
            }
        }
    }
